...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    // Notifica o provedor do agendamento
  ...
  async delete(req, res) {
    ...
    // Verificando se o cancelamento é possível. Só se pode cancelar o agendamento
    // se ele for cancelado 2h antes da hora marcada.
